...
(function enhanceLessonUi(){
  ...
  if(completion&&lessonNumber){const links=document.createElement("p");links.className="artifact-templates";links.innerHTML=`<strong>Artifact templates:</strong> <a href="../../templates/lesson-activity.md" target="_blank">lesson activity</a> · <a href="../../templates/capstone-increment.md" target="_blank">capstone increment</a>${lessonNumber>=6?' · <a href="../../templates/model-evidence-card.md" target="_blank">model evidence card</a>':""}. Copy the prompts into your own Markdown file and preserve it for the next lesson.`;completion.querySelector(".completion-actions")?.before(links);}
})();
